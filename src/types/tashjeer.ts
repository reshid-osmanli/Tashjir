...
export interface WordBox {
  ...
  bottomY: number;
  /**
   * مواضع حدود الحروف المرئية داخل الكلمة، مقيسة من **حافتها اليمنى**
   * (لأن الكتابة من اليمين). طولها عدد الحروف + ١: العنصر i هو المسافة من
   * الحافة اليمنى إلى بداية الحرف i.
   *
   * وجودها هو ما يجعل التحديد الحرفي والوصلة المنقّطة تقعان على الحرف
   * المقصود بالضبط. القسمة المتساوية على عدد الحروف — وهي ما كان يفعله
   * المحرر — تضع علامة «السين» فوق «الألف»، لأن عرض الحروف العربية متفاوت
   * تفاوتا كبيرا (السين ٠٫٧٢ من حجم الخط والألف ٠٫٢٦).
   */
