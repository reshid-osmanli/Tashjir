...
2. **سطر مستقل لكل تركيب قراءة.** لا يتشارك خطان مسارا واحدا وإن تباعدا أفقيا. والسطر ليس «وجها في موضع» بل **قراءة راوٍ للآية كلها** (انظر: الأوجه المركّبة أدناه).
...
### الأوجه المركّبة: السطر قراءة كاملة لا حكما مفردا

الراوي يقرأ الآية **مرة واحدة**. فإذا كان في قراءته مدٌّ في أول الآية، وفرشٌ في كلمة، وإدغامٌ في كلمة ثالثة، فهذه كلها في **سطر واحد**، كل حكم مثبَّت فوق كلمته:

```
   فَتَلَقَّىٰٓ  ءَادَمُ  مِن  رَّبِّهِۦ  كَلِمَٰتٍ  فَتَابَ  عَلَيۡهِ  إِنَّهُۥ
        ╎                    ╎                          ╎
     مد ٢                  فرش                       إدغام
 ب ┈┈┈┈┈├══┤┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈├══┤┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈├══┤┈┈┈┈
```

وكان المحرك السابق يفرد لكل حكم سطرا، فيوهم أن قالون يقرأ الآية ثلاث مرات، ويضطر المحقق إلى مدّ خط واحد على كلمتين متباعدتين ليجمعهما.

**تعدد الأوجه = ضرب لا جمع.** إذا كان للراوي في موضع وجهان (تحقيق وتقليل) وفي آخر ثلاثة (قصر، توسط، طول)، فسطوره ستة: يُثبَّت أول ما يمر به في الترتيب وتُستوفى فروعه، ثم ينتقل إلى وجهه الثاني:

```
  تحقيق × قصر  →  تحقيق × توسط  →  تحقيق × طول  →  تقليل × قصر  → ...
```

**الترتيب ترتيب الأمة.** تُرتَّب السطور بقالون أولا ومعه من وافقه في التركيب نفسه، ثم بقية تراكيب قالون، ثم من يليه في طيبة النشر (ورش، ثم البزي...). وترتيب تراكيب الراوي الواحد يتبع **درجته هو**: الوجه المقدَّم عنده أولا، ولو كان مؤخَّرا عند غيره (`strengthByNarrator`).

**وحدة القراءة قد تكون طريقا.** إذا خُصّ طريق بحكم في هذه الآية (كالأزرق عن ورش) انقسم الراوي إلى طريقيه، فصار لكل طريق سطوره. وإن عمّ الحكم طرقه كلها بقي الراوي وحدة واحدة، فلا تتضاعف السطور بلا فائدة.

الملفات: `src/lib/tashjeer/combination-engine.ts` (بناء التراكيب) و`src/lib/tashjeer/ordering.ts` (قواعد الترتيب المشتركة). ويمكن الرجوع إلى الوضع القديم — سطر لكل وجه — من لوحة التحكم: **تكوين السطر → سطر لكل وجه في كل موضع**، وهو مفيد في المراجعة الموضعية.

### بطاقة السطر: إمام، أو راوٍ، أو طريق

يُختصر طرف السطر بأعلى مستوى يصح الاختصار إليه:

| الحالة | المطبوع |
|--------|---------|
| اجتمع راويا الإمام على التركيب | **رمز الإمام** (أ، ت، ث...) |
| انفرد راوٍ، أو اجتمع طريقاه | **رمز الراوي** (ب، ج، د...) |
| انفرد طريق من طرق الراوي | **اسم الطريق** مكتوبا: «الأزرق»، «الأصبهاني» |

الطرق لا رموز لها؛ فهي مئات ولا تحتمل ترميزا يُحفظ. أما رمز الإمام ورمز الراوي فيُحرَّران من لوحة التحكم. الملف: `src/lib/tashjeer/reader-symbols.ts`.
...
## نافذة العمل: الوقف والابتداء عبر الآيتين

الوقف والابتداء لا يقفان عند حدود الآية، فللمحرر **نافذة عمل** لا آية واحدة:

- **وصل الآيتين.** عند تفعيله تُضم الآية التالية إلى النافذة وتتسلسل مواضع الكلمات عبرهما (١، ٢، ٣...)، فيمكن تسجيل حكم يبدأ في آخر الأولى وينتهي في أول الثانية، ويشجّره المحرك سطرا واحدا. ويُطبع رقم الآية الأولى في موضعه بين الآيتين. الملف: `src/lib/tashjeer/reading-window.ts`.
- **تشجير مقطع وحده.** الوقف يقسم النافذة مقاطع؛ فإذا اختار المحقق مقطعا اقتصر التشجير على مواضعه، وحُصرت أطراف الأسطر في كلماته، وبقي ما عداه ظاهرا مخفَّتا ليُقرأ السياق. يُحفظ الاختياران في المستند (`readingWindow`) فيكونان قابلين للمراجعة والتصدير.

---

## النص والقياس

- **الآية على خط واحد.** لا يلتف النص مهما طال؛ يتمدد عرض اللوحة ويتكفل التكبير والتمرير الأفقي بالعرض. الالتفاف كان يقطع الآية سطرين فتتقاطع الوصلات مع أسطر النص. (`LayoutOptions.singleLine`)
- **مواضع الحروف مقيسة لا مقسومة.** حدود كل حرف مأخوذة من عرضه الحقيقي (`WordBox.characterOffsets`)، وفي المتصفح تُقاس بالخط المرسوم به النص نفسه (`text-metrics.ts`). القسمة المتساوية على عدد الحروف كانت تضع علامة حرف على غيره، لأن «الألف» نحو ثلث عرض «السين».
- **الأرقام عربية.** مقادير المد وأرقام الآيات والمواضع تُطبع بالأرقام العربية (الهندية) بخط المصحف. المرجع: `src/lib/utils/arabic-numbers.ts`.
